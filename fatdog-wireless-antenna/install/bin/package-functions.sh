...
#   print_reverse "*** triggers at the top of the install test result page"
  cat << 'EOF'
____
PACKAGE FATDOG-WIRELESS-ANTENNA - RECOMMENDED INSTALLATION SETTINGS:
